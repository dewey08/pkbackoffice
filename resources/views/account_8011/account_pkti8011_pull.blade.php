            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body shadow-lg">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h4 class="card-title">Detail Account ผัง 1102050102.8011</h4>
                                <p class="card-title-desc">รายละเอียดตั้งลูกหนี้</p>
                            </div>
                            <div class="col"></div>
                            <div class="col-md-2 text-end">
                                <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-info Savestamp" data-url="{{url('account_pkti8011_stam')}}">
