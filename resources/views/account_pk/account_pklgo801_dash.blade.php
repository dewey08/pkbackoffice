                                    ...
                                    <div class="flex-grow-1 ">
                                        <?php 
                                            ...
                                            LEFT JOIN acc_debtor ad ON ad.cid = a.cid AND ad.vstdate = a.vstdate
                                                    WHERE ad.account_code="1102050102.801"             
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-end mt-2 me-4">
                                                <a href="{{url('account_pk801/'.$item->months.'/'.$item->year)}}" target="_blank"> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <a href="{{url('account_pk801_stm/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank"> 
