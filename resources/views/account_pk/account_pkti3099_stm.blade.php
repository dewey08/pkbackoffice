            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header"> 
                       รายละเอียดตั้งลูกหนี้ผัง 1102050101.3099
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-end" style="color:rgb(17, 17, 17)" width="7%">{{ $item->amount}}</td>
                                        ...
                                        <?php
                                            ...
                                            // $total3 = $total3 + $item->EPOpay;
                                            // $total4 = $total4 + $item->rep_money;
                                        ?>
