        ...
        <form action="{{ route('acc.account_802_dash') }}" method="GET">
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-start">
                    ...
                    <a href="{{url('account_802_pull')}}" class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary" target="_blank">
                                        ...
                                        <div class="flex-grow-1 ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 text-end me-4">
                                                    <a href="{{url('account_802_stmnull_all/'.$item->months.'/'.$item->year)}}" target="_blank">
                                                        <div class="widget-chart widget-chart-hover">
