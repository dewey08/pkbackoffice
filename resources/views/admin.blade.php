 ...
 <br>
    {{-- <div class="container mt-3"> --}}
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-md-2"> 
                    <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(152, 226, 224)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(199, 181, 240)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a>
                                                    ...
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                 <i class="fa-solid fa-3x fa-hospital-user font-size-25 mt-3" style="color: rgba(240, 161, 204, 0.945)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(245, 176, 250)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a >
                                                    ...
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                <i class="fa-solid fa-3x fa-book-open-reader font-size-25 mt-3" style="color: rgb(194, 137, 199)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a >
                                                    ...
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                <i class="fa-solid fa-3x fa-truck-medical font-size-25 mt-3" style="color: rgb(152, 239, 248)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
        ...
        <div class="row">
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(247, 217, 217)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                {{-- <a > --}}
                                                    ...
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                <i class="fa-solid fa-3x fa-clipboard font-size-25 mt-3" style="color: rgb(248, 182, 182)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgba(174, 180, 177, 0.781)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a href="{{ url('article/article_index') }}" target="_blank">
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                <i class="fa-solid fa-3x fa-building-shield font-size-25 mt-3" style="color: rgba(131, 150, 140, 0.692)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(255, 222, 161)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a href="{{ url('supplies/supplies_index') }}" target="_blank">
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                 <i class="fa-solid fa-3x fa-paste font-size-25 mt-3" style="color: rgb(252, 212, 138)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(171, 175, 173)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(170, 167, 250)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(190, 223, 248)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
        ...
        <div class="row">
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(145, 220, 231)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a href="{{ url('meetting/meettingroom_dashboard') }}" target="_blank">
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                 <i class="fa-solid fa-3x fa-house-laptop font-size-25 mt-3" style="color: rgb(184, 147, 226)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
            ...
            <div class="col-xl-2 col-md-2">
                <div class="main-card mb-3 card shadow-lg" style="background-color: rgb(247, 198, 176)">
                    <div class="grid-menu-col">
                        <div class="g-0 row">
                            <div class="col-sm-12">
                                <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a href="{{ url('pkclaim/pkclaim_info') }}" target="_blank">
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                 <i class="fa-solid fa-3x fa-sack-dollar font-size-25 mt-3" style="color: rgb(245, 180, 150)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a href="{{ url('account_info') }}" target="_blank">
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                <i class="fa-solid fa-3x fa-money-check-dollar font-size-25 mt-3" style="color: rgb(223, 136, 173)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
                                            ...
                                            <div class="avatar-sm me-3">
                                                <a href="{{ url('p4p') }}" target="_blank">
                                                    {{-- <span class="avatar-title bg-white text-primary rounded-3"> --}}
                                                        ...
                                                        <p >
                                                            <button class="mt-5 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3" style="height: 70px;width: 105px">
                                                                <i class="fa-solid fa-p text-danger font-size-20 mt-2"></i>
                                                                <i class="fa-solid fa-4 text-warning font-size-20 mt-2"></i>
                                                                <i class="fa-solid fa-p text-info font-size-20 mt-2"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
                                            ...
                                            <div class="avatar-sm me-2">
                                                <a href="{{ url('medicine_salt') }}" target="_blank">
                                                    <span class="avatar-title bg-white text-primary rounded-3">
                                                        <p style="font-size: 10px;">
                                                            <button class="mt-5 mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info avatar-title bg-white text-primary rounded-3">
                                                                 <i class="fa-solid fa-3x fa-square-person-confined font-size-25 mt-3" style="color: rgb(210, 211, 210, 0.781)"></i>
                                                            </button>
                                                        </p>
                                                    </span>
                                                </a>
