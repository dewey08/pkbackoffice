    ...
    public function account_803_pulldata(Request $request)
    {
        ...
        $acc_debtor = DB::connection('mysql2')->select(' 
            SELECT o.vn,o.an,o.hn,pt.cid,concat(pt.pname,pt.fname," ",pt.lname) ptname
                ...
                AND vp.pttype IN(SELECT pttype from pkbackoffice.acc_setpang_type WHERE pttype IN(SELECT pttype FROM pkbackoffice.acc_setpang_type WHERE pang ="1102050102.803" AND opdipd ="OPD"))
